...
export async function inference(img) {
  const boxes = await detect_objects_on_image(img);
  draw_image_and_boxes(img, boxes);
}

function draw_image_and_boxes(img, boxes) {
  let imageElement;
  ...
  if (img instanceof HTMLImageElement) {
    ...
    imageElement.onload = renderBoxes;
  }
